package com.longmaple.ttmall.frontier.config;
...
public class ClientConfig {
	...
	private OAuth2ProtectedResourceDetails resource() {
		...
		resourceDetails.setAccessTokenUri("http://localhost:8901/oauth/token");
		resourceDetails.setUserAuthorizationUri("http://localhost:8901/oauth/authorize");
		...
		resourceDetails.setPreEstablishedRedirectUri("http://localhost:8686/callback");
